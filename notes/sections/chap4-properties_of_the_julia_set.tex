...
\begin{remark}[$z$ non-exceptional $\implies J \subset \closure{[z]}$] We now
    consider the relationship between $J$ and an orbit $[z]$ of a
...
\begin{remark}[$z$ non-exceptional and $z \in J \implies J = \closure{[z]}$] If
    $z$ is in $J$, then it is not exceptional, so $[z]$, and hence also
