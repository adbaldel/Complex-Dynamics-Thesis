...
\begin{definition}[Perfect set]
    A set $E$ is called \emph{perfect} if it is closed and contains no
    isolated points. Equivalently, $E$ is perfect if it equals its own derived
    set, meaning $E = E_0$ (where $E_0$ is the set of all accumulation points of
    $E$).
\end{definition}
...
\begin{remark}[$z$ non-exceptional $\implies J \subset \closure{[z]}$] We now consider the relationship
...
\begin{remark}[$z$ non-exceptional and $z \in J \implies J = \closure{[z]}$] If $z$ is in $J$, then it
...
\begin{theorem}[$z$ non-exceptional $\implies J \subset \closure{\orbit^-(z)}$ and if $z \in J$ they are equal]
...
\begin{theorem}[$R^{-n}(E)$ converges to $J$ for $E$ compact and non-$F$-limit]
    ...
    the sequence $(R^n(z))_{n \in \N}$ does not accumulate at any point of
