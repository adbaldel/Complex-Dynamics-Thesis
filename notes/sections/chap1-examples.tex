...
\label{sec:iteration_of_mobius_transformations}
...
\label{sec:iteratcion_of_z_squared}
...
\label{sec:iteration_of_z_squared_minus_one}
...
\label{sec:iteration_of_z_squared_plus_c}
...
\label{sec:iteration_of_z_plus_one_over_z}
...
\label{sec:iteration_of_two_z_minus_one_over_z}
...
\label{sec:newtons_approximation}
